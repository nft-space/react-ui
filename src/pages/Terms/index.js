...
import { LegalPageInfoContainer } from "./styles";

export const Terms = () => {
  return (
    <LegalPageInfoContainer>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity (“you”) and NFT SPACE
        Ltd, doing business as NFT SPACE ("NFT SPACE," “we," “us," or “our”),
        concerning your access to and use of the https://nftspace.cloud website
        ...
        Use are posted. The information provided on the Site is not intended for
        ...
        Custom Branding Hide “Powered by Termly” logo Customize Policy Style
        Theme Select "Create New Theme" to edit your policy style. To create a
        custom theme, please upgrade. Pro+ plans start as low as $15/month. View
        Plans Dashboard Consent Management Policies Privacy Policy Cookie Policy
        Terms and Conditions EULA Return Policy Disclaimer Shipping Policy
        Settings Sharp (Default) APPLY THEME You have surpassed your 1 policy
        limit. Please upgrade to publish additional policies. Learn More Act
        ...
        violate the GrammLeach-Bliley Act (GLBA). All users who are minors in
        ...
        parent or guardian read and agree to these Terms of Use prior to you
        using the Site.
      </p>
      <br />
      ...
      <p>
        ...
        Policy: https://www.nftspace.cloud. By using the Site, you agree to be
        bound by our Privacy Policy, which is incorporated into these Terms of
        Use. Please be advised the Site is hosted in the United Kingdom. If you
        ...
        Kingdom, and you agree to have your data transferred to and processed in
        the United Kingdom.
      </p>
      <br />
      ...
      <p>
        ...
        provisions of the law of your country of residence. NFT SPACE Ltd and
        yourself both agree to submit to the non-exclusive jurisdiction of the
        courts of Bristol, which means that you may make a claim to defend your
      ...
      <p>
        ...
        dispute, controversy, or claim related to these Terms of Use (each
        ...
        written notice from one Party to the other Party. Binding Arbitration
        ...
        clause constitutes acceptance. The seat of arbitration shall be Bristol,
        ...
        Kingdom. Restrictions The Parties agree that any arbitration shall be
      ...
      <p>
        ...
        THE ACTION, WILL AT ALL TIMES BE LIMITED TO $1,000.00 USD. CERTAIN US
